...
import 'package:flutter_demo/const.dart';class IndexBar extends StatefulWidget {
...
class _IndexBarState extends State<IndexBar> {
  ...
  double _indicatorY = 0.0; //气泡默认的y
  String _indicatorText = 'A'; //气泡默认的文字
  bool _indocatorHidden = true; //气泡默认隐藏
